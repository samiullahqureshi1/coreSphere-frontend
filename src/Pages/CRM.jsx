...
export default function CRM() {
  ...
  const tabs = [
    ...
    { key: "pipeline", label: "Sales Pipeline", icon: <FiBarChart2 /> },
    { key: "leads", label: "Leads", icon: <FiList /> },
    { key: "contacts", label: "Contacts", icon: <FiUsers /> },
    { key: "accounts", label: "Accounts", icon: <FiBriefcase /> },
    { key: "activities", label: "Activities", icon: <FiCalendar /> },
    { key: "team", label: "Team", icon: <FiUserCheck /> },
  ...
  const renderContent = () => {
    const contentMap = {
      dashboard: {
        title: "CRM Overview",
        desc: "Welcome to your CRM Dashboard. View performance, deals, and client stats here.",
      },
      pipeline: {
        title: "Sales Pipeline",
        desc: "Track your deals from initial contact to final conversion.",
      },
      leads: {
        title: "Leads Management",
        desc: "Manage and qualify leads. Add, filter, or import leads easily.",
      },
      contacts: {
        title: "Contacts",
        desc: "View and manage all your customers and communication history.",
      },
      accounts: {
        title: "Accounts / Companies",
        desc: "Manage client organizations and their associated contacts.",
      },
      activities: {
        title: "Activities",
        desc: "Track calls, meetings, tasks, and follow-ups in one place.",
      },
      team: {
        title: "Team Management",
        desc: "Assign roles, monitor performance, and manage your sales team.",
      },
      products: {
        title: "Products & Services",
        desc: "Add and manage your products or services with pricing details.",
      },
      reports: {
        title: "Reports & Analytics",
        desc: "Get insights into leads, deals, and team performance.",
      },
      settings: {
        title: "Settings",
        desc: "Configure integrations, permissions, and notification preferences.",
      },
    };
    ...
    return (
      <div>
        <h2 className="text-xl font-semibold mb-3 text-indigo-700">{content.title}</h2>
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 ml-64 p-8">
        ...
        <div className="bg-white shadow-md rounded-2xl p-6 mb-6 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-indigo-700">CRM System</h1>
          <p className="text-sm text-gray-500">
            Manage Clients • Leads • Projects
          </p>
        </div>
