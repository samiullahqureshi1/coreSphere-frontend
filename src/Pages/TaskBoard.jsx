  ...
  return (
    <div className="flex flex-col h-full bg-gray-50">
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={() => setShowModal(true)}
          className={`flex items-center gap-2 bg-${primaryBlue} hover:bg-${primaryBlueHover} text-white px-5 py-2.5 rounded-xl shadow-md transition font-semibold`}
        >
      ...
      {/* Kanban Board */}
      <DragDropContext onDragEnd={handleDragEnd}>
        <div className="flex gap-6 min-w-[1400px] pb-6">
          {[
            { key: "backlog", title: "Backlog" },
            { key: "todo", title: "To Do" },
            { key: "inprogress", title: "In Progress" },
            ...
            <Droppable droppableId={col.key} key={col.key}>
              {(provided, snapshot) => (
                <div
                  ref={provided.innerRef}
                  {...provided.droppableProps}
                  className={`w-80 flex-shrink-0 p-4 rounded-xl transition-all duration-300 ${
                ...
                >
                  ...
                  <div className="flex justify-between items-center mb-3 border-b border-gray-100 pb-2">
                    <h3
                      className={`text-md font-bold text-${darkIndigo} flex items-center gap-2`}
                    >
                      {col.title}
                      <span
                        className={`text-xs bg-sky-200 text-${darkIndigo} px-2 py-0.5 rounded-full`}
                      >
                      ...
                      >
                        {(provided, snapshot) => (
                          <div
                            ...
                            className={`bg-white rounded-xl border border-gray-200 p-4 shadow-md cursor-pointer transition-all ${
                              snapshot.isDragging
                          ...
                          >
                            <div className="flex justify-between items-start mb-2">
                              <h4
                                className={`text-sm font-bold text-${darkIndigo}`}
                              >
                                {task.title}
                              </h4>
                              <button className="p-1 text-gray-400 hover:text-sky-600 rounded-full">
                                ...
                                <div className="flex -space-x-2">
                                  {task.assignees.map((emp, i) => (
                                    <img
                                      ...
                                      src={emp.avatar}
                                      alt={emp.name}
                                      className="w-7 h-7 rounded-full border-2 border-sky-300"
                                    />
                                  ))}
                                </div>
                              )}
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl w-full max-w-md p-6 shadow-xl">
            <div className="flex justify-between items-center mb-3">
              <h2 className="text-lg font-bold text-indigo-900">Add Task</h2>
              <FiX
                className="text-gray-500 cursor-pointer"
                onClick={() => setShowModal(false)}
              />
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 p-2 border rounded-lg focus:ring-2 focus:ring-sky-600 outline-none"
                  value={newTask.title}
                  onChange={(e) =>
                    setNewTask({ ...newTask, title: e.target.value })
                  }
              ...
              <button
                onClick={handleCreateTask}
                className="w-full bg-sky-600 hover:bg-sky-700 text-white py-2 rounded-lg mt-3 font-medium"
              >
                Create Task
              </button>
            </div>
